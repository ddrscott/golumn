...
Attribution
===========
Golumn once used Pandas for data import, but Panda's C dependencies made it too
difficult to use with py2app and was making the app bundle over 200 mb compared
to 70mb without it.
